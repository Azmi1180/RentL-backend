...
### Method: GET
>```
>http://localhost:5000/api/lapangans/{id}
>```

⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃

## End-point: Get By Type
### Method: GET
>```
>http://localhost:5000/api/lapangans
>```
...
## End-point: Get by City
### Method: GET
>```
>http://localhost:5000/api/lapangans?city=Jakarta
>```
### Query Params
...
## End-point: Delete Lapangan
### Method: DELETE
>```
>http://localhost:5000/api/lapangans/1
>```
...
### Method: PUT
>```
>http://localhost:5000/api/reviews/3
>```
### Body (**raw**)
...
## End-point: Get Available Slot
### Method: GET
>```
>http://localhost:5000/api/bookings/available-slots?lapanganId=1&bookingDate=2024-09-05
>```
### Query Params
...
### Method: POST
>```
>http://127.0.0.1:5000/api/checkout/
>```
### Body formdata
...
|Param|value|Type|
|---|---|---|
|full_name|User2|text|
|email|user2@mail.com|text|
|password|12345678|text|
|phone_number|08123456789|text|
